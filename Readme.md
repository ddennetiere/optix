...
All functions are exposed in C form, though it is internally written in C++. \
...
OptiX is free software. It is distributed without any waranty of any kind;
