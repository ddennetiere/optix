...
namespace AutoVersion{
	...
	#define RC_FILEVERSION 2,1,682,682
	#define RC_FILEVERSION_STRING "2, 1, 682, 682\0"
	static const char FULLVERSION_STRING [] = "2.1.682.682";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long BUILD_HISTORY  = 358;
