...
namespace AutoVersion{
	...
	#define RC_FILEVERSION 2,0,31,31
	#define RC_FILEVERSION_STRING "2, 0, 31, 31\0"
	static const char FULLVERSION_STRING [] = "2.0.31.31";
	
	//These values are to keep track of your versioning state, don't modify them.
	static const long BUILD_HISTORY  = 207;
