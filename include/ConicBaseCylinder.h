 ...
 *   \b theta0 |     Angle      | angle \f$ \theta_0 \f$ from surface center between focal rays and tangent plane
 *
 ...
 *  -   an ellipse if the product \f$ p^{-1}   q^{-1} \f$ is negative
 *  -   an hyperbola if the product \f$ p^{-1}   q^{-1} \f$ is positive
